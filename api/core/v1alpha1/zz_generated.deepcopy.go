...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObjectDescriptor) DeepCopyInto(out *ObjectDescriptor) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObjectDescriptor.
func (in *ObjectDescriptor) DeepCopy() *ObjectDescriptor {
	if in == nil {
		return nil
	}
...
func (in *SkyProviderSpec) DeepCopyInto(out *SkyProviderSpec) {
	*out = *in
	...
	if in.DependsOn != nil {
		...
		*out = make([]ObjectDescriptor, len(*in))
		copy(*out, *in)
	}
